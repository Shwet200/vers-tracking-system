        ...
        plugins: {
            ...
            callbacks: {
              label: function (context) {
                ...
                if (context.datasetIndex === 0) {
                  ...
                  return `Line of Best Fit: ${config.equation}`;
                }
              },
            },
          },
          annotation: {
            annotations: {
              equation: {
                type: 'label',
                xValue: config.lineData[Math.floor(config.lineData.length / 2)].x,
                yValue: Math.max(...config.lineData.map(d => d.y)),
                content: config.equation,
